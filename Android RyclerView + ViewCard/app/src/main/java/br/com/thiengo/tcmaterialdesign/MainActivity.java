...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TOOLBAR
            ...
            mToolbar.setTitle("Venta de Autos");
    ...
    // CATEGORIES
        private List<PrimaryDrawerItem> getSetCategoryList(){
            String[] names = new String[]{"Todos los Carros", "Carros de Lujo", "Carros Deportivos", "Carros de Colección", "Carros Populares"};
    ...
    // CAR
        ...
        public List<Car> getSetCarList(int qtd, int category){
            ...
            String description = "Nuestra empresa se encarga de dar los mejores carros , de lujo, deportivos, de coleccion y los más populares en el mercado. Para mayor informacion nos ubicamos al costado del MALL del SUR o tambien nos pueden llamar al número indicado...";
